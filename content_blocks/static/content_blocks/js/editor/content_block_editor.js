// todo fix dragon drop + expanders + scroll to error and/or replace everything with vanilla js.
...
(function ($) {
  $.fn.ContentBlockEditor = function (options) {
    ...
    $(document).on("click", "button.visible", function (e) {
      e.preventDefault();
      let $btn = $(this);
    ...
    function showSpinner($loader) {
      ...
      $loader.children(".bg").addClass("visible");
    }
